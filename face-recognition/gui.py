...
w = tk.Entry(root,textvariable=svalue, width=20, fg="red",font=('times', 20)) # adds a textarea widget
...
add_btn = tk.Button(root,text="Add Person", command=add_person,fg="black", bg="#BDF2D5"  ,width=10  ,height=1, borderwidth = 20, activebackground = "Red" ,font=('times', 20, 'italic bold '))
...
trainF_btn = tk.Button(root,text="Train Model", command=train_fisher_btn_load,fg="black", bg="#BDF2D5"  ,width=10  ,height=1, borderwidth = 20, activebackground = "Red" ,font=('times', 20, 'italic bold '))
...
recogF_btn = tk.Button(root,text="Recognize", command=recog_fisher_btn_load,fg="black", bg="#BDF2D5"  ,width=10  ,height=1, borderwidth = 20, activebackground = "Red" ,font=('times', 20, 'italic bold '))
